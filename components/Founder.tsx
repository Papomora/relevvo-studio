      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
        ...
        <div ref={photoRef} className="relative" style={{ willChange: 'opacity' }}>
          ...
          >
            ...
            <p className="font-mono text-xs text-white/60 mt-1" style={{ letterSpacing: '0.08em' }}>años</p>
          </div>
        ...
        <div ref={textRef} style={{ willChange: 'opacity' }}>
          <span
            ...
            style={{ color: 'rgba(167,139,250,0.9)', letterSpacing: '0.14em' }}
          >
          ...
          <div className="mb-8">
            <span className="font-mono text-xs text-white/60 uppercase mb-3 block" style={{ letterSpacing: '0.12em' }}>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link
              href="/papo"
              className="text-sm px-6 py-3 inline-flex items-center gap-2 text-white/65 hover:text-white transition-colors"
            >
              Conoce al fundador
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                <path d="M5 12h14M12 5l7 7-7 7" />
